    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit Competition Details</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Competition Details</h3>
                            </div>
                            <!-- /.card-header -->

                            <div class="card-body">
                                {{ Form::model($competitionDetail, ['route' => ['competitionDetail.update', $competitionDetail->id], 'method' => "PUT",'files' => true,'enctype'=>'multipart/form-data']) }}
                                ...
                                <div class="row">
                                        ...
                                        <div id="myform">
                                            ...
                                            <div class="row" id="{{$key}}">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="events[{{$key}}][date]" class="form-control float-right" id="reservationtime{{$key}}" value="{{$eventDateTime->date}}">
                                                            <input type="hidden" name="events[{{$key}}][id]" value="{{$eventDateTime->id}}">
                                                        </div>
                                                        <!-- /.input group -->
                                                    </div>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input id="minute{{$key}}" type="text" class="form-control" name="events[{{$key}}][time]" value="{{$eventDateTime->time}}">
                                                    {{--<p id="minuteKEY"></p>--}}
                                                </div>
                                            </div>
                                                @endforeach
                                    ...
                                    <input type="hidden" name="competition_details_id" value="{{$competitionDetail->id}}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="eGroup">
                                            <option value="National" {{ old('eGroup',$competitionDetail->eGroup)=='National' ? 'selected' : ''  }}>National</option>
                                            <option value="Regional" {{ old('eGroup',$competitionDetail->eGroup)=='Regional' ? 'selected' : ''  }}>Regional</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        {{ Form::submit('Edit Competition', ['class' => 'btn btn-primary btn-block btn-h1-spacing mt-3']) }}
                                    </div>
...
<script>
    $(document).ready(function () {
        var c = "{{$competitionDetail->eventDateTimes()->count()}}";
        var i=c-1;
